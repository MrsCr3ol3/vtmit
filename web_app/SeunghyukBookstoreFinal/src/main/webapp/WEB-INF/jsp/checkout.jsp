...
<main>
    ...
    <section id="checkoutMain">
        ...
        <p style="font-weight:bold; font-size: 35px; margin-bottom: 10px">Checkout</p>
                ...
                <form id="checkoutForm" action="<c:url value='checkout'/>" method="post">
                    <table id="checkOutTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="textField" type="text" size="20" maxlength="45" name="address" value="${p.customerForm.address}" required/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="textField" type="text" size="20" maxlength="45" id="cardnumber" name="ccNumber"
                                       value="${p.customerForm.ccNumber}" required/>
                            </td>
                        </tr>
        ...
        <span id="checkoutInfoText">
            ...
            <strong>Subtotal <fmt:formatNumber type="currency" currencySymbol="&dollar;" value="${p.cart.subtotal/100.00}"/></strong> + <strong>Surcharge $5</strong>
        </span>
            </div>
